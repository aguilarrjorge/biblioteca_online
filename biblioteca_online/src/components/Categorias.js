    ...
    <div className="categorias">
      ...
      {searchResults &&
        searchResults.map((item) => {
          return <> 
          <div className='categorias__search'>
              <div className='categorias__elementSearch'>
                <Link className='categorias__element--link' to={`/detalles/${item.id}`} >
                  <img className="categorias__element--img" src={`/images/psicologia/${item.id}.png`} alt="" />       
                  <div className='categorias__element2'>
                      <p className='categorias__element--p1'>{item.address.street}</p>
                      <p className='categorias__element--p2'>{item.name}</p>
                      ...
                      <p className='categorias__element--p5'> $150.00 {item.id} </p>
                    </div>                 
                </Link>
          </div>
        </div>
